...
import { LineBasicMaterial, MeshPhysicalMaterial, Vector2, SRGBColorSpace } from "three";
...
function Avatar({
  ...
  bodyNormalTexture.colorSpace = THREE.NoColorSpace;
  tshirtNormalTexture.colorSpace = THREE.NoColorSpace;
  teethNormalTexture.colorSpace = THREE.NoColorSpace;
  hairNormalTexture.colorSpace = THREE.NoColorSpace;
      ...
      <div className="relative w-[50vw]">
        ...
        >
          ...
          <div className="flex flex-col">
            <p className="text-md text-white mb-2">{transcript || "Click 'Start' to begin speaking..."}</p>
